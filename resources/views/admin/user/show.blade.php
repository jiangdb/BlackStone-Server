            ...
            <div class="col-lg-6 col-lg-offset-1">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="{{ $user->wx_user!=null?($user->wx_user->avatar_url??'/images/default_avatar.png'):'/images/default_avatar.png'}}" class="img-circle img-responsive"> </div>
